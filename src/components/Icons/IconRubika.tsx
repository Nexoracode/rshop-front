...
export default function IconRubika({
  title = "لوگو خاکستری",
  ...props
}: Props) {
  return (
    <svg
      ...
      {...props}
    >
      {title && <title id="logoGrayTitle">{title}</title>}
      ...
      <path
        ...
        fill="#6b7280" // gray-500
      />
      {/* نقطه کوچک انتهایی – می‌توانید حذف کنید اگر لازم نبود */}
      <path d="M602.83,233.66" fill="#d1d5db" />
    </svg>
  );
}
