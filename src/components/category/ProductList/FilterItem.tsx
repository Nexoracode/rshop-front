...
import SelectableFilter from "../ProductFilterSidebar/SelectableFilter";
...
export default function FilterItem({
  ...
  const { handleSetAttributeQuery, query } = useProductFilter();
          ...
          <div className="h-full pb-[8rem] no-scrollbar overflow-auto">
            ...
            {items && (
              <SelectableFilter
                ...
                onChange={(v) => handleSetAttributeQuery(String(attrId), v)}
              />
            )}
          </div>
        </div>
